...
export const metadata = {
  title: 'About Us - NetTech Solutions',
  description: 'Learn about NetTech Solutions, our mission, and our commitment to quality.',
};
